...
import { Loader2, Mail, Lock, User, Eye, EyeOff, Chrome, Building } from "lucide-react";
...
const signupSchema = z.object({
  ...
  role: z.enum(["admin", "tpo", "faculty", "coordinator"]),
      ...
      <Card className="w-full max-w-lg">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Join EduEmpower Campus to manage your institution's placement activities
          </CardDescription>
        </CardHeader>
