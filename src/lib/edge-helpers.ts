...
// Account extraction from headers (Edge Runtime compatible)
...
// User extraction from headers (Edge Runtime compatible)
...
// Require specific role middleware (Edge Runtime compatible)
...
// Require specific permission middleware (Edge Runtime compatible)
...
// Get user permissions based on role (Edge Runtime compatible)
...
// Request validation helper (Edge Runtime compatible)
